...
function TablePagination({ limit, onPageChange, page, totalItems }: Props) {
      ...
      <PaginationItem key={1}>
        <button
          className={cn(
            ...
            page === 1 && "text-black bg-primary rounded-md"
          )}
      ...
      <PaginationItem key={i}>
        <button
          className={cn(
            ...
            page === i && "text-black bg-primary rounded-md"
          )}
    ...
    pages.push(
      <PaginationItem key={totalPages}>
        <button
          className={cn(
            "size-8 justify-center items-center flex disabled:cursor-not-allowed text-sm",
            page === totalPages && "text-black bg-primary rounded-md"
          )}
  ...
  return (
    <Pagination className="justify-end m-0 w-fit select-none">
